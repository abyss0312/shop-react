...
function NavBar() {
    ...
    const pages = ['Categorias', 'Productos', 'Contactos'];
    const settings = ['Profile', 'Account', 'Dashboard', 'Logout'];
    const {isAuth} = useAppSelector(UserSelector);
  
    //methods to handle app bar
      ...
      <Toolbar disableGutters>
        ...
        { isAuth == true 
          ...
          <>
            ...
            <Button color="inherit" onClick={handleOnClickSignUp}>SignUp</Button>
          </>
        }
       
        <Box sx={{paddingTop:'4px', paddingLeft:1}}>
